        ...
        <section className="w-full py-20" id="approach">
            ...
            <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
                <Card
                    ...
                    description = "Research phase determines the product development and promotion strategies. We want every product we create to be successful - that is why we work closely with founders. We do customer development, talk to potential users about the product, determine their real weaknesses. We research existing products in the market and key competitors, we conduct traffic analysis. Based on the research, we provide recommendations for further product look & feel and Internet promotion using social media, SEO and inbound marketing."
                    >
                    <CanvasRevealEffect
                        animationSpeed={5.1}
                ...
                <Card
                    ...
                    description = "Product launch is only the start of the journey. We stay on the line and help founders to move products forward - we come up with new features based on user feedback, improve marketing strategy, help with Internet promotion.">
                    <CanvasRevealEffect
                        animationSpeed={3}
